...
type ChannelCreateOpts struct {
    ...
    ChannelFlagPermanent optional.String
}
 ...
 * @param "ChannelFlagPermanent" (optional.String) -  Mark channel as permanent
...
func (a *ChannelApiService) ChannelCreate(ctx _context.Context, channelName string, localVarOptionals *ChannelCreateOpts) (ChannelCreateResponse, *_nethttp.Response, error) {
	...
	if localVarOptionals != nil && localVarOptionals.ChannelFlagPermanent.IsSet() {
		localVarQueryParams.Add("channel_flag_permanent", parameterToString(localVarOptionals.ChannelFlagPermanent.Value(), ""))
	}
 ...
 * @param "ChannelName" (optional.String) -  Channel name
...
func (a *ChannelApiService) ChannelEdit(ctx _context.Context, cid string, localVarOptionals *ChannelEditOpts) (MinimalResponse, *_nethttp.Response, error) {
	...
	localVarQueryParams.Add("cid", parameterToString(cid, ""))
	if localVarOptionals != nil && localVarOptionals.ChannelName.IsSet() {
		localVarQueryParams.Add("channel_name", parameterToString(localVarOptionals.ChannelName.Value(), ""))
	}
	if localVarOptionals != nil && localVarOptionals.ChannelTopic.IsSet() {
		localVarQueryParams.Add("channel_topic", parameterToString(localVarOptionals.ChannelTopic.Value(), ""))
	}
...
*/
func (a *ChannelApiService) ChannelInfo(ctx _context.Context, cid string) (ChannelInfoResponse, *_nethttp.Response, error) {
	var (
		...
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  ChannelInfoResponse
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/channelinfo"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
